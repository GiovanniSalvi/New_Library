...
* In the homepage, users can find all books title in the archive:[homepage](https://github.com/GiovanniSalvi/New_Library/blob/master/static/images/test%20homepage.png). At the top of the page are displayed navbar links to navigate through the app:[navbar]()
